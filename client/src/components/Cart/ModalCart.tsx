...
const ModalCart = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute top-1/2 -translate-y-1/2 left-0 right-0 w-[450px] mx-auto bg-emerald-primary border border-yellow-primary rounded-md z-[2000]  opacity-0 scale-90 will-change-transform transition-all duration-300",
