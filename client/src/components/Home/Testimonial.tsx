  ...
  return (
    <section className="py-[50px] bg-rating bg-cover bg-no-repeat bg-center">
      <Container>
        ...
        >
          <SwiperSlide className="rounded-lg p-[45px] bg-emerald-primary">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-[26px] leading-[34px] mb-2">Trần Đức</h1>
            ...
            <p className="font-light text-base">
              Món ăn ở đây hầu hết đều rất ngon, khẩu vị phù hợp với tôi, tôi sẽ
              luôn ủng hộ nhà hàng Dola Restaurant
            </p>
          </SwiperSlide>
          <SwiperSlide className="rounded-lg p-[45px] bg-emerald-primary">
            <div className="flex items-center justify-between mb-5">
              ...
              <svg
                className="w-[70px] h-[70px] text-yellow-primary"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                fill="currentColor"
              >
